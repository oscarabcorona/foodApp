...
import barSelectors from 'modules/bar/barSelectors';
import destroyActions from 'modules/bar/destroy/barDestroyActions';
import destroySelectors from 'modules/bar/destroy/barDestroySelectors';
import actions from 'modules/bar/list/barListActions';
import selectors from 'modules/bar/list/barListSelectors';
...
class BarToolbar extends Component {
  state = {
...
function select(state) {
  return {
    ...
    hasPermissionToEdit: barSelectors.selectPermissionToEdit(
      state,
    ),
    hasPermissionToDestroy: barSelectors.selectPermissionToDestroy(
      state,
    ),
    hasPermissionToCreate: barSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: barSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(BarToolbar);
