...
import BarListItem from 'view/bar/list/BarListItem';
              ...
              {!loading &&
                rows.map((row) => (
                  <TableRow key={row.id}>
                    ...
                    <TableCell>
                      <BarListItem value={row[fields.order.name]} />
                    </TableCell>
                    <TableCell>
...
export default connect(select)(DeliveryListTable);
