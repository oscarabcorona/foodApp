...
import KitchenFormModal from 'view/kitchen/form/KitchenFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/kitchen/kitchenSelectors';

class KitchenAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return KitchenService.listAutocomplete(value, limit);
  };
