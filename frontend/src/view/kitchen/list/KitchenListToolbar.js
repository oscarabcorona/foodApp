...
import kitchenSelectors from 'modules/kitchen/kitchenSelectors';
import destroyActions from 'modules/kitchen/destroy/kitchenDestroyActions';
import destroySelectors from 'modules/kitchen/destroy/kitchenDestroySelectors';
...
class KitchenToolbar extends Component {
  state = {
    ...
    return (
      <ToolbarWrapper>
        ...
        {this.props.hasPermissionToAuditLogs && (
          <Button
            component={Link}
            to="/audit-logs?entityNames=kitchen"
...
function select(state) {
  return {
    ...
    hasPermissionToEdit: kitchenSelectors.selectPermissionToEdit(
      state,
    ),
    hasPermissionToDestroy: kitchenSelectors.selectPermissionToDestroy(
      state,
    ),
    hasPermissionToCreate: kitchenSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: kitchenSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(KitchenToolbar);
