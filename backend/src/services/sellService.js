...
/**
 * Handles Sell operations
 */
module.exports = class SellService {
  constructor({ currentUser, language }) {
    this.repository = new SellRepository();
  ...
  /**
   * Destroy all Sells with those ids.
   *
   * @param {*} ids
   */
  ...
  /**
   * Finds Sells based on the query.
   *
   * @param {*} args
   */
